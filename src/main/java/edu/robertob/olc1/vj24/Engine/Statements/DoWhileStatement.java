...
public class DoWhileStatement extends Instruction {

    public Instruction condition;
    public LinkedList<Instruction> doWhileBody;

    public DoWhileStatement(Instruction condition, LinkedList<Instruction> whileBody, int line, int column) {
        super(Types.VOID, line, column);
        this.condition = condition;
        this.doWhileBody = whileBody;
    }
    ...
    public Object execute(Tree tree, SymbolTable table) {
        ...
        do {
            for (var instruction : doWhileBody) {
